...
export function browse(roots, rootId, relativePath = '') {
...
export function createFolder(roots, rootId, relativePath, name) {
    ...
    if (!parentMatch || parentMatch.root.id !== rootId)
        return null;
