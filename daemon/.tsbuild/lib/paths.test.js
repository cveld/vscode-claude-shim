...
import { stripQuotes, toAbsoluteHostPath, resolveRoot, toContainerPath, toHostPath, classifyByExtension, resolveHostPath, } from './paths.js';
const roots = [
...
test('toAbsoluteHostPath resolves .. segments and normalizes slashes', () => {
    assert.equal(toAbsoluteHostPath('C:/work/git/github/cveld/Experiments/../Experiments/foo'), 'C:\\work\\git\\github\\cveld\\Experiments\\foo');
});
